...
const port = process.env.SERVER_PORT || process.env.PORT || 2300;        
const UUID = process.env.UUID || 'ebc7b825-a5db-4990-a907-2a8deb664c38'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cho4.husjhdm23.eu.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiODc0MGJjYjg0OTdlMjE2NWFlNTJmY2E2NTk2NTU1ZjMiLCJ0IjoiMmJlYTg5MDItN2UxNi00MjVkLTkxYTYtNGExOTJhMGE1NTUxIiwicyI6Ik1XRmxNakZpTnpFdE56UmxOQzAwWldFMUxUaGxOVGt0TnpNNFlUQmpNVE5tT1RJMSJ9';
